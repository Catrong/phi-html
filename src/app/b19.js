...
btn?.addEventListener("click", async function () {
    ...
    userInfo.innerHTML = `<div class="userId">
        ...
        <div class="userAva">
            <img src="./src/resources/html/avatar/${gameuser.avatar}.png" alt="avatar">
        </div>
        <div class="clg_rks">
            <div class="webClg">
                <img src="./src/resources/html/otherimg/${gameuser.ChallengeMode}.png" alt="Challenge">
...
async function openB19() {
    ...
    let b19Page = open('./src/resources/html/b19/displayB19.html', '_blank');
}
